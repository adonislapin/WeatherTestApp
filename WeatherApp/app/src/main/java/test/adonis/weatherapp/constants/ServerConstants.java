package test.adonis.weatherapp.constants;
...
public class ServerConstants {
    ...
    public static final String REQUEST_URL = "http://api.openweathermap.org/data/2.5/";
    public static final String WEATHER = "weather?";

    public static final String APPID = "f37cedbe6e5d72ff3a26c69e9686d24b";

    public static final String KEY_APPID = "APPID";
    public static final String qKeyParameter = "q";
